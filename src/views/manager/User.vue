  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="ip" label="ip属地" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="头像">
          <el-upload class="avatar-uploader" :action="$baseUrl + '/qiniu/image'" :headers="{ token: user.token }"
        ...
        <el-form-item label="生日" prop="birth">
          ...
          <el-date-picker v-model="form.birth" placeholder="生日" value-format="yyyy-MM-dd" format="yyyy-MM-dd"
            style="width: 100%;"></el-date-picker>
        </el-form-item>
        <el-form-item label="ip属地" prop="ip">
          <el-input v-model="form.ip" placeholder="ip属地" disabled></el-input>
        </el-form-item>
      </el-form>
