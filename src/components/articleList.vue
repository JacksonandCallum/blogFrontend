<template>
    <div>
        <div v-if="!$common.isEmpty(articleList)" class="recent-post-container-2">
            <div class="article-first">
                ...
                {{ articleList[0].categoryName }}
            </div>
            <div class="recent-post-item shadow-box background-opacity" v-for="blog in articleList" :key="blog.id"
