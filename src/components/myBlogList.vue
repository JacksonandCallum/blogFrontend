<template>
    <div>
        <div v-if="!$common.isEmpty(blogs)" class="recent-post-container-1">
            ...
            <div class="recent-post-item shadow-box background-opacity" v-for="blog in blogs" :key="blog.id"
                ...
                <div class="recent-post-item-post"
                    ...
                    <!-- 博主 热度 点赞 -->
                    <div class="post-meta"
                        style="margin-bottom: 15px;display: flex;flex-direction: row;align-items: center;justify-content: center;">
                        <span>
                            <svg viewBox="0 0 1024 1024" width="14" height="14" style="vertical-align: -2px;">
                                <path
                        ...
                        <div style="display: flex; flex-direction: row;">
                            <div style="margin: auto 4px;">
                                <proButtonPlus :info="'删除'" :before="'rgb(131, 123, 199)'"
                                    :after="'linear-gradient(45deg, #f43f3b, #ec008c)'" @click.native="del(blog.id)">
                                </proButtonPlus>
                            </div>
                            <div style="margin: auto 4px;">
                                <proButtonPlus :info="'编辑'" :before="'rgb(131, 123, 199)'"
                                    :after="'linear-gradient(45deg, #f43f3b, #ec008c)'"
                                    @click.native="editBlog(blog.id)">
                                </proButtonPlus>
                            </div>
                        </div>
                    </div>
        ...
        <div v-else class="recent-post-container-1">
            <div class="article-first">
                <svg viewBox="0 0 1024 1024" width="20" height="20" style="vertical-align: -2px;">
                    <path
                        d="M224.2 472.3c-13-5.7-3.7-23.5 8.2-19 91 34 146.8 108.7 182.4 138.5 5.6 4.7 14 2.9 17.3-3.5 16.8-32 45.8-113.7-57.1-168.6-87.3-46.5-188-53.6-247.3-82.2-14.5-7-31.1 4.6-29.9 20.7 5 69.7 28.9 124.7 62.3 181.5 67.3 114.3 140.6 132.9 216.6 104 2.2-0.9 4.5-1.8 7-3 7-3.4 8.3-12.9 2.5-18.1 0.1 0-45.7-69.3-162-150.3z"
            ...
            <div class="recent-post-item shadow-box background-opacity">
                <div class="recent-post-item-image"
                    style="display: flex;flex-direction: column;justify-content: center;align-items: center;color: orangered;font-weight: bolder;">
                    你要发表博客吗？
                </div>
                <div class="recent-post-item-post"
                    style="justify-content: center;align-items: center;font-size: 100px;">😎</div>
            </div>
            <div class="pagination-wrap">
                <div style="user-select: none">
                    ~~你还没有发布博客哦~~
